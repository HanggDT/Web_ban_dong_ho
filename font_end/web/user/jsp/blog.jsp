...
<!-- Mirrored from demo.hasthemes.com/mirora-preview/mirora/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Aug 2020 13:44:18 GMT -->
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
	                                                <img src="../user/img/blog/blog1.jpg" alt="blog">
	                                            </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                        ...
                                        <div class="post-media">
                                            <div class="post-gallery nav-vertical-center">
                                                <div class="single-post-gallery">
                                                    <img src="../user/img/blog/blog2-1024x613.jpg" alt="blog">
                                                </div>
                                                <div class="single-post-gallery">
                                                    <img src="../user/img/blog/blog3.jpg" alt="blog">
                                                </div>
                                                <div class="single-post-gallery">
                                                    <img src="../user/img/blog/blog5.jpg" alt="blog">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                ...
                                <div class="col-lg-6 mb--30">
                                    <article class="post single-post format-standard">
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
                                            		<img src="../user/img/blog/blog4-1024x613.jpg" alt="blog">
                                            	</a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                ...
                                <div class="col-lg-6 mb--30">
                                    <article class="post single-post format-standard">
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
                                            		<img src="../user/img/blog/post1-370x230.jpg" alt="blog">
                                            	</a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <div class="widget_conent">
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="../user/img/blog/post4-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                        ...
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="../user/img/blog/post3-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                            <div class="recent-post-content">
                                                <h4><a href="single-blog.html">Gravida luctus lorem accumsan est massa mauris.</a></h4>
                                        ...
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="../user/img/blog/post2-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                            <div class="recent-post-content">
                                                <h4><a href="single-blog.html">Gravida luctus lorem accumsan est massa mauris.</a></h4>
...
<!-- Mirrored from demo.hasthemes.com/mirora-preview/mirora/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Aug 2020 13:44:24 GMT -->
</html>