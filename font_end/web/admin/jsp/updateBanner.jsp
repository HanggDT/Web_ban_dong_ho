<%-- 
    ...
    Created on : Sep 22, 2020, 10:39:08 AM
    Author     : Thanh Nam
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <f:form action="update.htm" method="POST" commandName="banUp" role="form">
                                        <div class="card-body">
                                            <table>
                                                <tr>                                                
                                                    <td colspan="2"><f:hidden path="bannerId"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Banner Name</td>
