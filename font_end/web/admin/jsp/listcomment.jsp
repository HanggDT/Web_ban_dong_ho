<%-- 
    ...
    Created on : Nov 6, 2020, 4:42:09 PM
    Author     : Thanh Nam
--%>
...
<!--                                                    <th>Parent Id</th>-->
                                            ...
                                            <tbody>
                                                <c:forEach items="${listCmt}" var="cmt">
                                                    <tr>
                                                        <td>${cmt.commentId}</td>
                                                        <td>${cmt.product.productName}</td>
                                                        <td>${cmt.users.userName}</td>
                                                        <td>${cmt.createdateComment}</td>
                                                        <td>${cmt.commentContent}</td>
<!--                                                        <td>${cmt.parentId}</td>-->
                                                        
                                                        <td>${cmt.commentStatus}</td>
                                                        <td>
                                                            <button class="btn btn-outline-primary"><a href="auth.htm?commentId=${cmt.commentId}">Duyệt</a></button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
