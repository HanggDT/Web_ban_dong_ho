<%-- 
    Document   : newproduct
    Created on : Sep 24, 2020, 9:45:51 AM
    Author     : Thanh Nam
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <f:form action="insert.htm" method="POST" commandName="proNew" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <table>
                                                <tr>
                                                    <td>Product Id</td>
                                                    <td><f:input placeholder="Enter Product ID" path="productId"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Product Name</td>
                                                    <td><f:input path="productName" placeholder="Enter Product Name"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Title</td>
                                                ...
                                                <tr>
                                                    <td>Categories</td>
                                                    <td>
                                                        <select class="select2" multiple="multiple" name="listCate" data-placeholder="Select categories" style="width: 100%;">
                                                            <c:forEach items="${listCat}" var = "cat">
                                                                <option value="${cat.catalogId}">${cat.catName}</option>
                                                            </c:forEach>                           
                                                        </select>                                                 
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <c:forEach items="${listColor}" var="color">
                                                            <div class="checkbox">
                                                                <label data-toggle="collapse" data-target="#${color.colorName}" aria-expanded="false" aria-controls="${color.colorName}">
                                                                    <input type="checkbox" name="colors" value="${color.colorId}"/> ${color.colorName}
                                                                </label>
                                                            </div>
                                                            </div>
                                                            <div id="${color.colorName}" aria-expanded="false" class="collapse">
                                                                <div class="well">
                                                                    <table>
                                                                        <tr>
                                                                            <td>Quantity</td>
