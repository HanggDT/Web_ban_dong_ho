                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <button class="btn-sm" style="margin-bottom: 15px "><a href="preInsert.htm">Thêm mới banner</a></button>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listBan}" var="ban">
                                                <tr>
                                                    ...
                                                    <td>${ban.imagelink}</td>
                                                    <td>${ban.bannerLink}</td>
                                                    <td>${ban.bannerPriority}</td>
                                                    <td>${ban.bannerStatus}</td>
                                                    <td>
                                                        <button class="btn btn-outline-primary"><a href="preUpdate.htm?bannerId=${ban.bannerId}">Update</a></button>
                                                        <button class="btn btn-outline-primary"><a href="delete.htm?bannerId=${ban.bannerId}">Delete</a></button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
