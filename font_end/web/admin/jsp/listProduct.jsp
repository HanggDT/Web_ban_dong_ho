<%-- 
    ...
    Created on : Sep 24, 2020, 9:34:08 AM
    Author     : Thanh Nam
--%>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <button class="btn-sm" style="margin-bottom: 15px "><a href="preInsert.htm">Thêm product</a></button>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listPro}" var="pro">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-outline-primary"><a href="prodetail.htm?proId=${pro.productId}">Detail</a></button>
                                                        <button class="btn btn-outline-primary"><a href="preUpdate.htm?proId=${pro.productId}">Update</a></button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
